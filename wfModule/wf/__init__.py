...
SYNOPSIS
   ...
   options:
        ...
        -l : qual ficheiro ir buscar (que língua)
        
Description:

File:(quais as files que são usadas )
...
def calcRealFreq(freqDic,frequency,min_occur=3):
    ...
    #nome,n_occ,percentageFreq,percentageReal
    frequencyList = []
...
def main():
    ...
    cl=clfilter("nm:csl:", doc=__doc__)     ## option values in cl.opt dictionary
